...
import { Separator } from "@extraufla/ui/components/separator";
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@extraufla/ui/components/sheet";
import { Skeleton } from "@extraufla/ui/components/skeleton";
import { Tooltip, TooltipContent, TooltipTrigger } from "@extraufla/ui/components/tooltip";
import { useIsMobile } from "@extraufla/ui/hooks/use-mobile";
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: shadcn/ui pattern, Cookie Store API not viable here
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: shadcn/ui generated
